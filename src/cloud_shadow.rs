...
impl CloudShadowState {
    pub fn new(device: &wgpu::Device, queue: &wgpu::Queue) -> Self {
        let size = 256u32;
        // Generate tileable 2D noise texture on CPU using fastnoise-lite
        ...
        for y in 0..size {
            for x in 0..size {
                ...
                let o1 = noise1.get_noise_2d(fx, fy) * 0.5 + 0.5;
                let o2 = noise2.get_noise_2d(fx, fy) * 0.5 + 0.5;
                let o3 = noise3.get_noise_2d(fx, fy) * 0.5 + 0.5;
